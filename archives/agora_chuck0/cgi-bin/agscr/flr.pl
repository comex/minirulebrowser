...
<html lang="en-US">
<head>
<title>Agora: Full Logical Ruleset</title>
...
<p>
<h1 align=center>The Full Logical Ruleset</h1>
<p align=center><strong>
The Rules were last updated on
May 5, 2001
<br>and include effects of Proposals through Proposal
4146, and Proposal 4149.
</strong>
<p><hr><p>
<pre>
...
Annotation: as required by Rule 789.  Some include a list of
Relevant Rules:
...
There are currently 299 Rules:
   19 with Power=3
   30 with Power=2
  250 with Power=1

Lowest current Rule Number:           101
Highest current Rule Number:         1980
Highest Rule Number assigned so far: 1980
...
Amended(4) by Proposal 3900 (Elysion), Sep. 6 1999
...
Happy Birthday
      ...
      BE IT FURTHER RESOLVED that Payroll Clerk shall transfer 25
      Stems from the Bank to each Player who, during Agora's
      Birthday, posts to the Public Forum a message recognizing
      Agora's Birthday; but no Player shall receive more than one
      such transfer during each year's Birthday Celebration;
...
Amended(2) by Proposal 3927 (harvel), Oct. 10 1999
...
The Rules
  ...
  Rulekeepor" which includes Rules regulating the Logical Rulesets
  and Rule Titles.)
----------------------------------------------------------------------
...
Amended(3) by Proposal 3914 (Elysion), Sep. 19 1999
...
Currency Awards for New Players
      ...
      Period, the Registrar shall pay out to that Player the New
      Player Award as well as one Papyrus.
...
Amended(4) by Proposal 4132 (harvel), Apr. 5 2001
...
Amended(3) by Proposal 4132 (Elysion), Apr. 5 2001
...
Amended(2) by Proposal 4134 (harvel) Apr. 5 2001
...
Cantus Cygneus
      ...
      of the Courts shall post this document to the Public Forum along
      with a Writ of Fugere Agorae Grandissima Exprobratione,
      commanding the Player to be deregistered and instructing the
      Registrar to note the method of deregistration for that Player
      in subsequent Registrar Reports, as long as the Player remains
      deregistered.
...
Granting Power of Attorney
      ...
      Power of Attorney is given by the Grantor posting in the Public
      Forum, naming the Holder e is giving the Power of Attorney to,
      and the time period for which the Power of Attorney shall given.
      To be effective, this post must name a time that begins within
      the week following the posting. The Power of Attorney shall not
      be granted unless the Holder is an active Player and consents
...
Official Reports
      ...
      be part of the corresponding Officer's Weekly Report or Monthly
      Report.  Any information designated to be part of the Officer's
      Report but not explicitly designated part of the Monthly Report
      shall be part of the Weekly Report.  If no information is
      designated to be part of the Weekly (or Monthly) Report, then
      that Office has no Weekly (or, respectively, Monthly) Report.

      Each Officer's Report is an Official Report.

      The holder of an Office for which there is an Officer's Report
      shall maintain all information in the Report.  E shall post the
      Weekly Report at least once each Nomic Week and the Monthly
      Report at least once each month.  Failure to post the Weekly
      Report (if there is one) in a Nomic Week or the Monthly Report
      (if there is one) in a month is the Class 2 Infraction of
      Failure to Report.  The Assistant Director of Personnel and the
      Speaker are authorized to detect and report this Infraction.
...
History:
Created by Proposal 3700 (Swann), Mar. 19 1998
...
Amended(1) by Proposal 3980 (Steve), Mar. 1 2000
...
Amended(6) by Proposla 4071 (Steve), Sep. 14 2000
...
Amended(2) by Proposal 3950 (harvel), Dec. 8 1999
Amended(3) by Proposal 4103 (Murphy), Jan. 15 2001
...
Temporary Delegation of Office
      ...
      (a) the Delegating Player has posted to the Public Forum a
          Notice of Delegation, naming the Office being Delegated and
      ...
      (c) the Delegated Player has posted, within the week immediately
          preceding or immediately following the posting of the Notice
          of Delegation, and to the Public Forum, a Notice of Consent
          to Delegation for that Office;
...
Amended(2) by Proposal 4135 (harvel), Apr. 5 2001
...
Amended(10) by Proposal 4123 (Lindrum), Mar. 21 2001

----------------------------------------------------------------------

Rule 1664/18 (Power=2)
Rebellion
...
Rule 1893/10 (Power=1)
The Treasuror's Budget

      The Treasuror's Budget shall contain the Basic Officer
      Salary (BOS), an amount between 0 and 200 Stems inclusive.
      Additionally, the Budget shall contain the values of the
      following compensations:

          *  the New Player Award;
          *  the Minimum Income;
          *  the Judicial Salary;
          *  the Winner's Stipend;
          *  the Distributor's Gratuity;
          *  the Speaker's Gratuity; and
          *  for each Office, the Salary of that Office.
      ...
      shall be paid out, the amount to be paid out shall be the
...
======================================================================
The Oligarchy
  This Category includes Rules concerning the makeup of the
  Oligarchy.
----------------------------------------------------------------------
...
History:
Created by Proposal 3980 (Steve), Mar. 1 2000
Amended(1) by Proposal 01-005 (Steve), Feb. 2 2001
...
The Speaker, Sanity, and Buying Democracy
        ...
        would otherwise be an Ordinary Proposal, for which the
        Voting Period has not yet concluded, and which has never been
        Contested, a Sane Proposal, With 3 Supporters.  This
        declaration may occur before the Voting Period commences; if
        it does, then this supported declaration turns the Proposal
        into a Democratic Proposal, and makes it Sane, requiring its
        Distribution Cost to be modified as required by other Rules.
        If this supported declaration occurs during the Voting Period
        for the Proposal, then the Proposal is not modified unless at
        least one Papyrus is transferred to the Bank for this stated
        purpose by any Player.  If this transfer occurs, then the
        Proposal becomes Democratic and Sane, all Votes already cast
        on the Proposal prior to the change are cancelled and its
        Voting Period is extended to end seven days after it became a
        Sane Proposal.

        Any Player may Contest an Interested Proposal, which would
        otherwise be an Ordinary Proposal and for which the Voting
        Period has not yet concluded, by sending a message to the
        Public Forum stating e is doing so.  If this Player is an
        Untainted Speaker, then the Proposal becomes Contested when e
        receives three Supporters.  If this Player is not an Untainted
        Speaker, then the Proposal becomes Contested if and only if e
        receives three Supporters and e publicly transfers 0.1VE to
        the Bank for the Contest.

        If a Proposal is Contested, any Player may publicly transfer
        any number of VEs to the Bank with a clear. unambiguous
        statement that this transfer is made either for or against the
        Contest.  At the end of the Voting Period, the Contest is
        Succesful if strictly more VEs have been publicly transferred
        to the Bank for the Contest than have been publicly
        transferred to the Bank against the Contest.  If equal numbers
        of VEs have been publicly transferred to the Bank both for and
        against the Contest, then the Contest is Succesful only if the
        Proposal was Contested by an Untainted Speaker.

        If the Contest is not Succesful, the Voting Period is
        considered to have ended, and the Proposal is considered an
        ordinary Ordinary Proposal for any further actions.

        If the Contest is Succesful, then all Votes cast on the
        Proposal are cancelled.  The Proposal becomes a Democratic
        Proposal.  The Voting Period is considered not to have ended,
        and is extended a further seven days.
...
Amended(6) by Proposal 3980 (Steve), Mar. 1 2000

----------------------------------------------------------------------

Rule 1764/12 (Power=1)
Modes of Voting
...
Budgets
      ...
      Maintainer.  The Maintainer shall post the Budget to the Public
      Forum as soon as possible whenever it changes.
...
Standing Down
      ...
      Election may stand down, by posting a message to the Public
      Forum to that effect. The player is then no longer to be
      considered a Candidate for that Election. Any further votes
      cast in eir favour are invalid, and e cannot win the Election.
...
The Right to Call Elections
      ...
      This right is exercised by posting an announcement in the Public
      Forum that lists a number of Offices, and declares that the
      Speaker is exercising eir right to call Elections for these
      Offices.  If the Speaker posts such a message, is not Tainted at
      the time of posting, and has not exercised this right since e
      last became Speaker, the Electee of each Office on the list
      (assuming that the Office has an Electee) is retired from
      Office.
...
======================================================================
Orders
  This Category includes Rules concerning Orders generally.
----------------------------------------------------------------------
...
History:
Created by Proposal 3704 (General Chaos), Mar. 19 1998
Amended() by Proposal 3897 (harvel), Aug. 27 1999
...
History:
Created by Proposal 2457, Feb. 16 1996
Amended(1) by Proposal 3574 (Kolja A.) , Oct. 30 1997, substantial
...
Delivering Judgement
  ...
  by the Judge, as well as Judicial Orders
----------------------------------------------------------------------
...
History:
Created by Proposal 3676 (General Chaos), Jan. 30 1998
...
Amended(6) by Proposal 3768 (Chuck), Jul. 22 1998
...
Overturning Judgement
  ...
  Judgements, Appellate Orders, and the office of Justiciar.
----------------------------------------------------------------------
...
Amended(2) by Proposal 3704 (General Chaos), Mar. 19 1998
...
Rule 1815/0 (Power=1)
Crimes and Infractions without Penalties

      No action is a Crime or an Infraction unless defined as such by
      the Rules.  If the Rules define an act to be a Crime or an
      Infraction, but fail to prescribe a penalty for that act, then
      there is no penalty for that act.  If the Rules define an act to
      be an Infraction, but fail to authorize any Player or Players to
      report instances of that Infraction, then that Infraction cannot
      be reported.
...
Notices of Infraction
      ...
      of Infraction by posting to the Public Forum that it is eir
      ...
      regarding the circumstances surrounding the offending action
...
======================================================================
The Rulekeepor
  This Category includes Rules concerning the Office of Rulekeepor,
  as well as Rules regulating the Logical Ruleset and Rule Titles.
----------------------------------------------------------------------
...
======================================================================
Property
  This Category includes Rules concerning Property in general.
----------------------------------------------------------------------
...
Amended(6) by Proposal 4099 (Murphy), Jan. 15 2001
...
The Right of Patronage
      ...
      more Players, with a total of not more than 30 Stems.  The
      Players to receive the award must not have received a Patronage
      award within the preceding four weeks, and the Speaker must
      provide a reason along with the Notice of Transfer. All such
      Patronage Awards in a single Week must be posted in a single
      message.
...
Default Procedure for Auctions
      ...
      (e) Start of Auction: The Auction begins at the time the first
          ...
          Currency, the number of items, and the value of the
          Starting Bid.
      ...
      (g) Making Bids: Each Bidder may make as many Bids as e desires
          ...
          particular Auction, and the amount of eir Bid. A Bid is
          only valid if it satisfies the following conditions:
...
======================================================================
The Bank
  This Category includes Rules concerning the Bank.
----------------------------------------------------------------------
...
======================================================================
Bonds
  This Category includes Rules concerning Bonds and the Office of
  Usuror.
----------------------------------------------------------------------
...
History:
Created by Proposal 4124 (Kelly), Mar. 28 2001
...
======================================================================
Stems
  This Category includes Rules concerning the Currency of Stems and
  the Office of the Payroll Clerk.
----------------------------------------------------------------------
...
Announcing a Win
      ...
      may then declare the Win by sending a message to the Public
      Forum containing the following information:
      ...
      When a message declaring the win is sent, if and only if the
      message contains all the required information, the Player or
      Players who, at that time, are eligible to Win immediately Win
      the Game.
...
Amended(1) by Proposal 4081 (Elysion), Oct. 30 2000
Amended(2) by Proposal 4110 (Ziggy), Feb. 13 2001
...
======================================================================
Points and the Scorekeepor
  This Category includes Rules on Points and the Office of the
  Scorekeepor
----------------------------------------------------------------------
...
Pardoning Lawlessness
      ...
      announcing e is doing so in the Public Forum. Then the following
      events shall occur:
       ...
       iii) The Pardoned Player shall then post a Formal Apology to
            the Public Forum for eir Lawlessness. The CotC may include
            a list of up to ten Prescribed Words in eir Pardon.
...
Amended(3) by Proposal 3703, Mar. 9 1998
...
History:
Created by Proposal 4146 (Goethe), Apr. 22 2001

----------------------------------------------------------------------

Rule 1446/13 (Power=1)
Contests
...
======================================================================
Honour
  This Category includes Rule 1377.
----------------------------------------------------------------------

Rule 1377/14 (Power=1)
The Herald
